...
def is_tor_running(host='127.0.0.1', port=9150, timeout=1):
    try:
...
def launch_tor_shell():
    current_os = sys.platform
    is_windows = current_os == "win32"
    
    tor_socks_port = "9150"
    
    tor_is_active = is_tor_running(port=int(tor_socks_port))
    ...
    try:
        ...
        if tor_is_active:
            ...
            while True:
                ...
                current_tor_running = is_tor_running(port=int(tor_socks_port))
